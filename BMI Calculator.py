...
def BMI():
    ...
    #you can change value , because different country have different bmi index
...
Label(root, text="Height (cm):", font="arial 10", bg="lightblue").place(x=20, y=130)
Label(root, text="Weight (kg):", font="arial 10", bg="lightblue").place(x=240, y=130)
